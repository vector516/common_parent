 ...
 * 
 */
@WebServiceClient(name = "OrderServiceImplService", targetNamespace = "http://impl.service.bos.itheima.com/", wsdlLocation = "http://localhost:8085/bs/order?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.bos.itheima.com/", "OrderServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/bs/order?wsdl");
    ...
    public OrderServiceImpl getOrderServiceImplPort() {
        return super.getPort(new QName("http://impl.service.bos.itheima.com/", "OrderServiceImplPort"), OrderServiceImpl.class);
    }
    ...
    public OrderServiceImpl getOrderServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.bos.itheima.com/", "OrderServiceImplPort"), OrderServiceImpl.class, features);
    }
