...
public class Config {
	...
	//分区导出模板
	private String  subareaExportTemplate;

	public String getSubareaExportTemplate() {
		return subareaExportTemplate;
	}

	public void setSubareaExportTemplate(String subareaExportTemplate) {
		this.subareaExportTemplate = subareaExportTemplate;
	}
