 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.crm.itheima.com/", wsdlLocation = "http://localhost:8889/crm?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.crm.itheima.com/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8889/crm?wsdl");
    ...
    public CustomerServiceImpl getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.crm.itheima.com/", "CustomerServiceImplPort"), CustomerServiceImpl.class);
    }
    ...
    public CustomerServiceImpl getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.crm.itheima.com/", "CustomerServiceImplPort"), CustomerServiceImpl.class, features);
    }
